...
namespace iAdamBrown\Flash\Tests;

use Mockery as m;
use PHPUnit\Framework\TestCase;
use iAdamBrown\Flash\SessionStore;
use iAdamBrown\Flash\FlashNotifier;
...
class FlashTest extends TestCase
{
    ...
    {
        $this->session = m::mock(SessionStore::class);
        $this->flash = new FlashNotifier($this->session);
    }

    /** @test */
    public function it_displays_default_flash_notifications(): void
    {
    ...
    /** @test */
    public function it_displays_info_flash_notifications(): void
    {
        $this->session->shouldReceive('flash')->with('flash_notification.message', 'Welcome Aboard');
        $this->session->shouldReceive('flash')->with('flash_notification.title', 'Notice');
        $this->session->shouldReceive('flash')->with('flash_notification.level', 'info');
    ...
    /** @test */
    public function it_displays_success_flash_notifications(): void
    {
        $this->session->shouldReceive('flash')->with('flash_notification.message', 'Welcome Aboard');
        $this->session->shouldReceive('flash')->with('flash_notification.title', 'Notice');
    ...
    /** @test */
    public function it_displays_error_flash_notifications(): void
    {
    ...
    /** @test */
    public function it_displays_warning_flash_notifications(): void
    {
    ...
    /** @test */
    public function it_displays_custom_message_titles(): void
    {
    ...
    /** @test */
    public function it_displays_flash_overlay_notifications(): void
    {
    ...
    /** @test */
    public function it_displays_flash_overlay_notifications_with_custom_level(): void
    {
        $this->session->shouldReceive('flash')->with('flash_notification.message', 'Overlay Message');
        $this->session->shouldReceive('flash')->with('flash_notification.title', 'Notice');
        $this->session->shouldReceive('flash')->with('flash_notification.level', 'danger');
